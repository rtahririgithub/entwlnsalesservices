...
public class SubscribedProductSummaryVO implements Serializable{
	...
	protected SalesProductLineVO productLine;
     ...
     *     
     */
    public SalesProductLineVO getProductLine() {
        return productLine;
    }
     ...
     *     
     */
    public void setProductLine(SalesProductLineVO value) {
    ...
    public static class ProductInstance implements Serializable{
        ...
        public static class InternetComponent implements Serializable{
            ...
            //added to store addonpack from consolidated account profile rest resonse
			protected SubscribedProductSummaryVO.ProductInstance.InternetComponent.AddOnPackList addOnPackList;
			...
			public SubscribedProductSummaryVO.ProductInstance.InternetComponent.AddOnPackList getAddOnPackList() {
				return addOnPackList;
			}

			public void setAddOnPackList(SubscribedProductSummaryVO.ProductInstance.InternetComponent.AddOnPackList addOnPackList) {
				this.addOnPackList = addOnPackList;
			}
            ...
            public static class AddOnPackList implements Serializable
            {
				...
				protected List<AddOnPackVO> addOnPack;

            	public List<AddOnPackVO> getAddOnPackList() {
            		if (addOnPack == null) {
            			addOnPack = new ArrayList<AddOnPackVO>();
            		}
            		return this.addOnPack;
            	}

            	public void setAddOnPackList(List<AddOnPackVO> addOnPack) {
        ...
        public static class SingleLineComponent implements Serializable{
            ...
            protected SubscribedProductSummaryVO.ProductInstance.SingleLineComponent.HomePhonePackIdList homePhonePackIdList;
			...
			public SubscribedProductSummaryVO.ProductInstance.SingleLineComponent.HomePhonePackIdList getHomePhonePackIdList() {
				return homePhonePackIdList;
			}

			public void setHomePhonePackIdList(
					SubscribedProductSummaryVO.ProductInstance.SingleLineComponent.HomePhonePackIdList homePhonePackIdList) {
            ...
            public static class HomePhonePackIdList implements Serializable
            {
            	/**
				 * 
				 */
				...
				protected List<String> homePhonePackId;

            	public List<String> getHomePhonePackId() {
            		if (homePhonePackId == null) {
            			homePhonePackId = new ArrayList<String>();
            		}
            		return this.homePhonePackId;
            	}

            	public void setHomePhonePackId(List<String> homePhonePackId) {
            		this.homePhonePackId = homePhonePackId;
            	}
            }
            ...
            public static class CallingFeatureList implements Serializable{
                ...
                public static class CallingFeature implements Serializable{
                    ...
                    protected String callingFeatureId;
					...
					public String getCallingFeatureId() {
						return callingFeatureId;
					}

					public void setCallingFeatureId(String callingFeatureId) {
