...
public class MessageDO implements Serializable{
	 ...
	 */
	private List<MessageDescDO> messsageDescriptionTextList;
	...
	public String getLocaleSpecificMessageDescText(Locale locale) {
		List<MessageDescDO> msgDescTextList = getMesssageDescriptionTextList();
		if(msgDescTextList != null && msgDescTextList.size()>0){
			for(MessageDescDO msgDescDO : msgDescTextList){
	 ...
	 */
	public List<MessageDescDO> getMesssageDescriptionTextList() {
	...
	public void setMesssageDescriptionTextList(
			List<MessageDescDO> messsageDescriptionTextList) {
		this.messsageDescriptionTextList = messsageDescriptionTextList;
	}
	
	public void addMessageDescDO(MessageDescDO messageDescDO){
		if(this.messsageDescriptionTextList != null){
			messsageDescriptionTextList.add(messageDescDO);
		}else{
			this.messsageDescriptionTextList = new ArrayList<MessageDescDO>();
	 ...
	 * @param transactionId
	 */
	public MessageDO(Exception exception, String contextData, String transactionId){
	 ...
	 * @param transactionId
	 */
	public MessageDO(String messageCode,String contextData, String transactionId){
	 ...
	 * @param transactionId
	 */
	public MessageDO(Exception exception, String messageCode, String contextData, String transactionId){
	 ...
	 * @param messageType
	 */
	public MessageDO(Exception exception, String messageCode, String contextData, String transactionId, String messageType){
		this.contextData = contextData;
		this.messageCode = messageCode;
		this.transactionId = transactionId;
		this.exception = exception;
	 ...
	 * @param transactionId
	 */
	public MessageDO(String messageCode,String contextData, String transactionId, String messageType){
		this.messageCode = messageCode;
		this.contextData =  contextData;
		this.transactionId = transactionId;
		this.messageType = messageType;
	...
	public MessageDO(String messageCode, String messageType){
		this.messageCode = messageCode;
		this.messageType = messageType;
		this.timestamp = new Date();
	}
	...
	public String toString() {
		...
		if (messsageDescriptionTextList != null){
			for (MessageDescDO msgDesc : messsageDescriptionTextList){
