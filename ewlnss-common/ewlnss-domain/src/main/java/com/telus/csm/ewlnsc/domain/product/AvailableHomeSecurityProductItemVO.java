...
public class AvailableHomeSecurityProductItemVO {
  ...
  public AvailableHomeSecurityProductItemVO productItemGroupCategories(List<ProductItemGroupCategoryVO> productItemGroupCategories) {
    this.productItemGroupCategories = productItemGroupCategories;
    return this;
  }

  public AvailableHomeSecurityProductItemVO addProductItemGroupCategoriesItem(ProductItemGroupCategoryVO productItemGroupCategoriesItem) {
  ...
  **/
  ...
  public AvailableHomeSecurityProductItemVO equipments(List<AvailableFFHEquipmentTypeVO> equipments) {
    this.equipments = equipments;
    return this;
  }

  public AvailableHomeSecurityProductItemVO addEquipmentsItem(AvailableFFHEquipmentTypeVO equipmentsItem) {
