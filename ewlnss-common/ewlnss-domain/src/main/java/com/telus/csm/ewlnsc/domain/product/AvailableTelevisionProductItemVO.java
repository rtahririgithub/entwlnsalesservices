...
public class AvailableTelevisionProductItemVO {
  ...
  public void setProductItemConstraintGroupList(
	...
	public AvailableTelevisionProductItemVO productItemGroupCategories(List<ProductItemGroupCategoryVO> productItemGroupCategories) {
    this.productItemGroupCategories = productItemGroupCategories;
    return this;
  }

  public AvailableTelevisionProductItemVO addProductItemGroupCategoriesItem(ProductItemGroupCategoryVO productItemGroupCategoriesItem) {
  ...
  **/
  ...
  public AvailableTelevisionProductItemVO equipments(List<AvailableFFHEquipmentTypeVO> equipments) {
    this.equipments = equipments;
    return this;
  }

  public AvailableTelevisionProductItemVO addEquipmentsItem(AvailableFFHEquipmentTypeVO equipmentsItem) {
  ...
  */
  ...
  public String toString() {
    ...
    sb.append("class AvailableTelevisionProductItem {\n");
