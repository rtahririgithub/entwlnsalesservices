...
/**
 * Summarized version of a Sweeetner offer.
 * 
 * <p>Java class for SweetenerSummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SweetenerSummary">
 *   &lt;complexContent>
...
@XmlType(name = "SweetenerSummary", propOrder = {
    "eligibleOfferIdentifierList",
    "stackableInd"
})
public class SweetenerSummary
    ...
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SweetenerSummary)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SweetenerSummary that = ((SweetenerSummary) object);
        {
