...
/**
 * <p>Java class for WirelineEquipment complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WirelineEquipment">
 *   &lt;complexContent>
 ...
 *         &lt;element name="purchaseEquipmentList" type="{http://xmlschema.tmi.telus.com/xsd/Product/ProductOffering/OfferInformationTypes_v3}WirelineEquipmentItem" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="rentalEquipmentList" type="{http://xmlschema.tmi.telus.com/xsd/Product/ProductOffering/OfferInformationTypes_v3}WirelineEquipmentItem" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="byodEquipmentList" type="{http://xmlschema.tmi.telus.com/xsd/Product/ProductOffering/OfferInformationTypes_v3}WirelineEquipmentItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "WirelineEquipment", propOrder = {
...
public class WirelineEquipment
    implements Serializable, Equals, ToString
{
    ...
    protected List<WirelineEquipmentItem> purchaseEquipmentList;
    protected List<WirelineEquipmentItem> rentalEquipmentList;
    protected List<WirelineEquipmentItem> byodEquipmentList;
     ...
     * {@link WirelineEquipmentItem }
     * 
     * 
     */
    public List<WirelineEquipmentItem> getPurchaseEquipmentList() {
        if (purchaseEquipmentList == null) {
            purchaseEquipmentList = new ArrayList<WirelineEquipmentItem>();
        }
     ...
     * 
     */
    public List<WirelineEquipmentItem> getRentalEquipmentList() {
        if (rentalEquipmentList == null) {
            rentalEquipmentList = new ArrayList<WirelineEquipmentItem>();
        }
     ...
     * 
     */
    public List<WirelineEquipmentItem> getByodEquipmentList() {
        if (byodEquipmentList == null) {
            byodEquipmentList = new ArrayList<WirelineEquipmentItem>();
        }
     ...
     *     
     */
    public void setPurchaseEquipmentList(List<WirelineEquipmentItem> purchaseEquipmentList) {
     ...
     *     
     */
    public void setRentalEquipmentList(List<WirelineEquipmentItem> rentalEquipmentList) {
     ...
     *     
     */
    public void setByodEquipmentList(List<WirelineEquipmentItem> byodEquipmentList) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<WirelineEquipmentItem> thePurchaseEquipmentList;
        ...
        {
            List<WirelineEquipmentItem> theRentalEquipmentList;
        ...
        {
            List<WirelineEquipmentItem> theByodEquipmentList;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof WirelineEquipment)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final WirelineEquipment that = ((WirelineEquipment) object);
        {
        ...
        {
            List<WirelineEquipmentItem> lhsPurchaseEquipmentList;
            ...
            List<WirelineEquipmentItem> rhsPurchaseEquipmentList;
