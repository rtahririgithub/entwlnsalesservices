...
/**
 * <p>Java class for HsicComponent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="HsicComponent">
 *   &lt;complexContent>
 *     &lt;extension base="{http://xmlschema.tmi.telus.com/xsd/MarketingSales/SalesChannel/SalesCommonTypes_v5}HsicComponentHeader">
 *       &lt;sequence>
...
@XmlType(name = "HsicComponent", propOrder = {
    "productOrderHeader"
})
public class HsicComponent
    extends HsicComponentHeader
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof HsicComponent)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final HsicComponent that = ((HsicComponent) object);
        {
