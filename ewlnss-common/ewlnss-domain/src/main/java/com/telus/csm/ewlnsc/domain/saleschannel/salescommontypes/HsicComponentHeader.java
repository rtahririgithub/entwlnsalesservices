...
/**
 * <p>Java class for HsicComponentHeader complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="HsicComponentHeader">
 *   &lt;complexContent>
...
@XmlType(name = "HsicComponentHeader", propOrder = {
    "appointmentDetail"
})
@XmlSeeAlso({
    HsicComponent.class
})
public class HsicComponentHeader
    ...
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof HsicComponentHeader)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final HsicComponentHeader that = ((HsicComponentHeader) object);
        {
