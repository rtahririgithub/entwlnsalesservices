...
@XmlType(name = "IndividualName")
public class IndividualName
    extends com.telus.tmi.xmlschema.xsd.enterprise.basetypes.enterprisecommonname_v1.IndividualName
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IndividualName)) {
            return false;
        }
        if (this == object) {
            return true;
