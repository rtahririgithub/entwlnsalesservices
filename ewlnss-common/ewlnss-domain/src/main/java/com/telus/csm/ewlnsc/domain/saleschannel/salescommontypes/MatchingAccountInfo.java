...
/**
 * <p>Java class for MatchingAccountInfo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MatchingAccountInfo">
 *   &lt;complexContent>
...
@XmlType(name = "MatchingAccountInfo", propOrder = {
    "billingAddress",
    "billingAccountNumber",
    "balanceAmt"
})
public class MatchingAccountInfo
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MatchingAccountInfo)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MatchingAccountInfo that = ((MatchingAccountInfo) object);
        {
