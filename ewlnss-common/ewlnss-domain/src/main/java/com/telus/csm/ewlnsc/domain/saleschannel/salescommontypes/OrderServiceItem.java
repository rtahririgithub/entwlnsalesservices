...
/**
 * <p>Java class for OrderServiceItem complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="OrderServiceItem">
 *   &lt;complexContent>
 ...
 *         &lt;element name="autoRenewFundsSourceCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="purchaseFundsSourceCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "OrderServiceItem", propOrder = {
    "serviceCode",
    ...
    implements Serializable, Equals, ToString
{
    ...
    protected String autoRenewFundsSourceCode;
    protected String purchaseFundsSourceCode;
     ...
     *     
     */
    public String getAutoRenewFundsSourceCode() {
     ...
     *     
     */
    public void setAutoRenewFundsSourceCode(String value) {
     ...
     *     
     */
    public String getPurchaseFundsSourceCode() {
     ...
     *     
     */
    public void setPurchaseFundsSourceCode(String value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            String theAutoRenewFundsSourceCode;
        ...
        {
            String thePurchaseFundsSourceCode;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof OrderServiceItem)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final OrderServiceItem that = ((OrderServiceItem) object);
        {
        ...
        {
            String lhsAutoRenewFundsSourceCode;
            lhsAutoRenewFundsSourceCode = this.getAutoRenewFundsSourceCode();
            String rhsAutoRenewFundsSourceCode;
        ...
        {
            String lhsPurchaseFundsSourceCode;
            lhsPurchaseFundsSourceCode = this.getPurchaseFundsSourceCode();
            String rhsPurchaseFundsSourceCode;
