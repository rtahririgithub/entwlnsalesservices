...
/**
 * <p>Java class for RewardContract complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RewardContract">
 *   &lt;complexContent>
 ...
 *         &lt;element name="rewardList" type="{http://xmlschema.tmi.telus.com/xsd/MarketingSales/SalesChannel/SalesCommonTypes_v5}Reward" maxOccurs="100" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RewardContract", propOrder = {
    "contractDuration",
    "rewardList"
})
    ...
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RewardContract)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RewardContract that = ((RewardContract) object);
        {
