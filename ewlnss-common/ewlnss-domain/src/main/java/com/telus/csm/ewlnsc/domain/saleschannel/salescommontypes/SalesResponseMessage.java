...
@XmlSeeAlso({
    ...
    GetSalesOfferDetailResponseType.class,
    GetAvailableTermsResponseType.class,
    GetEquipmentSummaryResponseType.class,
    GetAvailableProductComponentResponseType.class,
    GetAvailableTelephoneNumberResponseType.class,
    GetNpaNxxResponseType.class,
    GetPricePlanSummaryResponseType.class,
    GetEquipmentInfoResponseType.class,
    GetPricePlanDetailResponseType.class,
    GetAvailableInstallDateResponseType.class,
    GetProductInventoryResponseType.class,
    GetAvailableManufactureAndProductResponseType.class,
    GetAvailablePerkListResponseType.class,
    GetNpaNxxListResponseType.class,
    GetInstallationDetailResponseType.class,
    GetAvailablePricePlanResponseType.class,
    GetServiceCompatibilityListResponseType.class,
    GetSalesRecommendationResponseType.class,
    GetAvailableBundleListResponse.class
})
