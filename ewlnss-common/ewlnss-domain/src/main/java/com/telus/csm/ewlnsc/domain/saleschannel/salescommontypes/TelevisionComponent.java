...
/**
 * <p>Java class for TelevisionComponent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TelevisionComponent">
 *   &lt;complexContent>
 *     &lt;extension base="{http://xmlschema.tmi.telus.com/xsd/MarketingSales/SalesChannel/SalesCommonTypes_v5}TelevisionComponentHeader">
 *       &lt;sequence>
...
@XmlType(name = "TelevisionComponent", propOrder = {
    "productOrderHeader"
})
public class TelevisionComponent
    extends TelevisionComponentHeader
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TelevisionComponent)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final TelevisionComponent that = ((TelevisionComponent) object);
        {
