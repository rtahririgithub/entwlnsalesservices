...
/**
 * <p>Java class for MobilityOfferHeader complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MobilityOfferHeader">
 *   &lt;complexContent>
...
@XmlType(name = "MobilityOfferHeader", propOrder = {
    "offerId",
    "offerCode",
    "offerProgramId",
    "systemId",
...
public class MobilityOfferHeader
    implements Serializable, Equals, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MobilityOfferHeader)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MobilityOfferHeader that = ((MobilityOfferHeader) object);
        {
            String lhsOfferId;
