 ...
 *
 */
public class ProductGroupCategorizationDelegate extends SpringBeanAutowiringSupport {

	private static Logger logger = Logger.getLogger(ProductGroupCategorizationDelegate.class);
	...
	private String transformMapKey(String serviceTypeCd, String parentProductCatalogueId){
		...
		logger.debug("ProductGroupCategorizationDelegate::transformMapKey serviceTypeCd=(" + serviceTypeCd + "), parentProductCatalogueId=(" + parentProductCatalogueId + ") result -> " + mapKey);
		return mapKey;
	}
