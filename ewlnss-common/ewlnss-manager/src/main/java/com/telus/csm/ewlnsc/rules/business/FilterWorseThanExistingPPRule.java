...
public class FilterWorseThanExistingPPRule  extends AbstractSpecification<Offer,TraceVO>{

	private SalesOfferCommonVO salesOfferCommonVO;
	String productCode;

	public FilterWorseThanExistingPPRule(SalesOfferCommonVO salesOfferCommonVO, String productCode) {
