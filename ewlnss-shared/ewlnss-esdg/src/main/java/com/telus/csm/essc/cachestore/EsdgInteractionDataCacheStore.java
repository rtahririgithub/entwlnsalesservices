...
public class EsdgInteractionDataCacheStore extends SalesCacheStore {
	
	public EsdgInteractionDataCacheStore() {
		super();
	}

	@Override
	protected Object doLoad(Object oKey) throws Exception {
		return esdgDatabaseAdapter.selectSalesInteraction((String)oKey);
	}
	...
	protected boolean doStore(Object oKey, Object oValue) throws Exception {		
		esdgDatabaseAdapter.saveSalesInteraction((EsdgInteractionDO_1) oValue);
		return true;
	}
