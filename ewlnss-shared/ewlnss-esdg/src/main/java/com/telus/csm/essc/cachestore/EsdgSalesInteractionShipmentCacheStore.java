...
public class EsdgSalesInteractionShipmentCacheStore extends SalesCacheStore {
	
	public EsdgSalesInteractionShipmentCacheStore() {
		super();
	}

	@Override
	protected Object doLoad(Object oKey) throws Exception {
		EsdgShipmentInteractionDO ret = esdgDatabaseAdapter.selectInteractionShipment((String)oKey);
		return ret;
	}
	...
	protected boolean doStore(Object oKey, Object oValue) throws Exception {		
		esdgDatabaseAdapter.saveSalesInteractionShipment((EsdgShipmentInteractionDO) oValue);
		return true;
	}
