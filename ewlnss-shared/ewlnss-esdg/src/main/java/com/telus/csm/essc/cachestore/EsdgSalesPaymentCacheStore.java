...
public class EsdgSalesPaymentCacheStore extends SalesCacheStore {
	
	public EsdgSalesPaymentCacheStore() {
		super();
	}

	@Override
	protected Object doLoad(Object oKey) throws Exception {
		EsdgPaymentDO ret = esdgDatabaseAdapter.selectSalesPayment((String)oKey);
		return ret;
	}
	...
	protected boolean doStore(Object oKey, Object oValue) throws Exception {		
		esdgDatabaseAdapter.saveSalesPayment((EsdgPaymentDO) oValue);
		return true;
	}
